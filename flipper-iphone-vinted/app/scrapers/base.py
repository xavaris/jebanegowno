...
class BaseScraper(ABC):
    ...
    async def human_delay(self, extra_min: int = 0, extra_max: int = 0) -> None:
        low = max(0, self.settings.RANDOM_DELAY_MIN_MS + extra_min)
        high = max(low, self.settings.RANDOM_DELAY_MAX_MS + extra_max)
